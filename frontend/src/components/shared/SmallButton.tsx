...
const SmallButtonModel = {
    primary: 'bg-blue-500 hover:bg-blue-600 rounded text-sm font-medium text-white px-3 py-1.5',
    secondary: 'bg-indigo-500 hover:bg-indigo-600 rounded text-sm font-medium text-white px-3 py-1.5',
